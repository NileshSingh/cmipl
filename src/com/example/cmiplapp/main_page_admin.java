...
public class main_page_admin extends Activity implements OnClickListener {
	...
	Button new_customer,sync,trade_cov,order_mgt,reports;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.ho_main_page); 
			...
			//reprots.setOnClickListener(this);
		...
		public void onClick(View v) {
			...
			if(v==reports)
			{
				 //Intent i=new Intent(getBaseContext(),Trade_coverage.class);
	             //startActivity(i);
			}
			if(v==order_mgt)
			{
				 //Intent i=new Intent(getBaseContext(),store_check.class);
	             //startActivity(i);
			}
		}
}